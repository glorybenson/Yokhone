...
<div class="content container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('edit.employee', $employee->id) }}">
                        ...
                        <div class="row mb-3">
                            <label for="employee_id" class="col-md-2 col-form-label text-md-end">{{ __('Employee ID') }}<span style="color:#ff0000">*</span></label>
                            <div class="col-md-10">
                        ...
                        <div class="row mb-3">
                            <label for="hiring_date" class="col-md-2 col-form-label text-md-end">{{ __('Hiring Date') }}<span style="color:#ff0000">*</span></label>
                            <div class="col-md-10">
                        ...
                        <div class="row mb-3">
                            <label for="CIN" class="col-md-2 col-form-label text-md-end">{{ __('CIN') }}<span style="color:#ff0000">*</span></label>
                            <div class="col-md-10">
                        ...
                        <div class="row mb-3">
                            <label for="CIN_proof" class="col-md-2 col-form-label text-md-end">{{ __('CIN Proof') }}<span style="color:#ff0000">*</span></label>
                        ...
                        <div class="row mb-3">
                            <label for="cell_1" class="col-md-2 col-form-label text-md-end">{{ __('Cell1') }}<span style="color:#ff0000">*</span></label>
                            <div class="col-md-10">
                        ...
                        <div class="row mb-3">
                            <label for="address" class="col-md-2 col-form-label text-md-end">{{ __('Address') }}<span style="color:#ff0000">*</span></label>
                        ...
                        <div class="row mb-3">
                            <label for="contact_full_name" class="col-md-2 col-form-label text-md-end">{{ __('Contact 1 Full Name') }}<span style="color:#ff0000">*</span></label>
                            <div class="col-md-10">
                        ...
                        <div class="row mb-3">
                            <label for="contact_1_cell" class="col-md-2 col-form-label text-md-end">{{ __('Contact 1 Cell') }}<span style="color:#ff0000">*</span></label>
                            <div class="col-md-10">
                        ...
                        <div class="row mb-3">
                            <label for="contact_1_cell2" class="col-md-2 col-form-label text-md-end">{{ __('Contact 1 Cell2') }}<span style="color:#ff0000">*</span></label>
                            <div class="col-md-10">
        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="d-flex align-items-center">
                    <h5 class="page-title">{{ __('Dashboard') }}</h5>
                    <ul class="breadcrumb ml-2">
                        <li class="breadcrumb-item"><a href="{{ route('employees') }}">{{__('Employees')}}
                        </a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title float-left">{{__('Create Employee')}}</h4>
                    <div class="text-right">
                        <a href="{{ route('employees') }}" class="btn btn-dark p-2">{{__('Back to Employees')}}
                        </a>
                    </div>
                </div>
                <div class="card-body">
