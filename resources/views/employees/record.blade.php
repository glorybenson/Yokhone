            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="AddNewRecord" tabindex="-1" aria-labelledby="AddNewRecordLabel"
                            aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="{{ route('add.record') }}">
                                        <div class="modal-body">
                                            ...
                                            <div class="row mb-3">
                                                <label for="date"
                                                    class="col-md-3 col-form-label text-md-end">{{ __('Date') }}<span
                                            ...
                                            <div class="row mb-3">
                                                <label for="reason"
                                                    class="col-md-3 col-form-label text-md-end">{{ __('Reason') }}<span
                                                        style="color:#ff0000">*</span></label>
                                                <div class="col-md-8">
                                                    <select class="select @error('reason') is-invalid @enderror"
                                                        name="reason" required>
                                                        <option value="">{{ __('Select Reason') }}</option>
                                                        <option value="Coaching"
                                                            {{ old('reason') == 'Coaching' ? 'selected' : '' }}>
                                                            {{ __('Coaching') }}</option>
                                                        <option value="Warning"
                                                            {{ old('reason') == 'Warning' ? 'selected' : '' }}>
                                                            {{ __('Warning') }}</option>
                                                        <option value="Sanction"
                                                            {{ old('reason') == 'Sanction' ? 'selected' : '' }}>
                                                            {{ __('Sanction') }}</option>
                                                    </select>
                                                    @error('reason')
                                                        <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="row mb-3">
                                                <label for="details"
                                                    class="col-md-3 col-form-label text-md-end">{{ __('Details') }}<span
                                                        style="color:#ff0000">*</span></label>
                                                <div class="col-md-8">
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <select
                                                                            ...
                                                                            <option value="Coaching"
                                                                                {{ $record->reason == 'Coaching' ? 'selected' : '' }}>
                                                                                {{ __('Coaching') }}</option>
                                                                            <option value="Warning"
                                                                                {{ $record->reason == 'Warning' ? 'selected' : '' }}>
                                                                                {{ __('Warning') }}</option>
                                                                            <option value="Sanction"
                                                                                {{ $record->reason == 'Sanction' ? 'selected' : '' }}>
                                                                                {{ __('Sanction') }}</option>
                                                                        </select>
                                                                        @error('reason')
                                                                            <span class="invalid-feedback" role="alert">
