                    ...
                    <div class="card-body">
                        ...
                        <div class="text-right mb-3">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#AddNewSalary">
                                {{ __('Add New Salary') }}
                            </button>
                        </div>
                        <!-- Modal -->
                        <div class="modal fade" id="AddNewSalary" tabindex="-1" aria-labelledby="AddNewSalaryLabel"
                            aria-hidden="true">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row mb-3">
                                                <label for="salary_amount"
                                                    class="col-md-4 col-form-label text-md-end">{{ __('Salary Amount') }}<span
                                                        style="color:#ff0000">*</span></label>
                                                <div class="col-md-6">
                                                    <input id="salary_amount" type="number" required
                                                        class="form-control @error('salary_amount') is-invalid @enderror"
                                                        name="salary_amount" value="{{ old('salary_amount') }}"
                                                        autocomplete="first name" autofocus> @error('salary_amount')
                                            ...
                                            <div class="row mb-3">
                                                <label for="salary_start_date"
                                                    class="col-md-4 col-form-label text-md-end">{{ __('Salary Start Date') }}<span
                                                        style="color:#ff0000">*</span></label>
                                                <div class="col-md-6">
                                                    <input id="salary_start_date" type="date" required
                                                        class="form-control @error('salary_start_date') is-invalid @enderror"
                                                        name="salary_start_date" value="{{ old('salary_start_date') }}"
                                            ...
                                            <div class="row mb-3">
                                                <label for="salary_end_date"
                                                    class="col-md-4 col-form-label text-md-end">{{ __('Salary End Date') }}<span
                                                        style="color:#ff0000">*</span></label>
                                                <div class="col-md-6">
                                                    <input id="salary_end_date" type="date" required
                                                        class="form-control @error('salary_end_date') is-invalid @enderror"
                                                        name="salary_end_date" value="{{ old('salary_end_date') }}"
                                                        autocomplete="first name" autofocus>
                                ...
                                <tbody>
                                    @if (isset($salaries))
                                        @foreach ($salaries as $salary)
                                            ...
                                            <div class="modal fade" id="AddNewSalary{{ $salary->id }}" tabindex="-1"
                                                                ...
                                                                <div class="row mb-3">
                                                                    <label for="salary_start_date"
                                                                        class="col-md-4 col-form-label text-md-end">{{ __('Salary Start Date') }}<span
                                                                            style="color:#ff0000">*</span></label>
                                                                    <div class="col-md-6">
                                                                        <input id="salary_start_date" type="date"
                                                                            required
                                                                            class="form-control @error('salary_start_date') is-invalid @enderror"
                                                                ...
                                                                <div class="row mb-3">
                                                                    <label for="salary_end_date"
                                                                        class="col-md-4 col-form-label text-md-end">{{ __('Salary End Date') }}<span
                                                                            style="color:#ff0000">*</span></label>
                                                                    <div class="col-md-6">
                                                                        <input id="salary_end_date" type="date"
                                                                            required
                                                                            class="form-control @error('salary_end_date') is-invalid @enderror"
